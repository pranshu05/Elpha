...
module.exports = {
    data: new SlashCommandBuilder()
        ...
        .addStringOption((option) =>
            option.setName('height').setDescription('height of QR in pixels')
        )
        .addStringOption((option) =>
            option.setName('width').setDescription('width of QR in pixels')
        )
        .addStringOption((option) =>
            option.setName('color').setDescription('color of QR')
        ),
