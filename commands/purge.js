    ...
    async execute(interaction) {
        ...
        if (
            ...
            interaction.channel
                ...
                .catch(() =>
                    interaction.channel.send(
                        'Bots can only purge messages that are less than 14 days old. This error could be caused by DiscordAPI Overload'
                    )
                )
            ...
            if (!modlog) {
                ...
                abc.send(
                    `Bulk messages deleted by ${interaction.user} in ${interaction.channel}`
                )
            }
        } else {
