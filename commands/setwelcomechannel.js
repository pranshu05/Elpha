...
module.exports = {
  ...
  async execute(interaction) {
    ...
    const wc_embed = new Discord.MessageEmbed()
      .setColor('#00ff00')
      .setTitle(
        `**:white_check_mark: Welcome channel has been set to ${interaction.options.getChannel(
          'welcome'
        )}**`
      );
    ...
    if (
      !interaction.guild.me
        .permissionsIn(interaction.options.getChannel('welcome'))
