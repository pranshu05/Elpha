            ...
            .addFields(
                {
                    ...
                    value: `${
                        ...
                        interaction.guild.channels.cache.filter(
                            (chan) => chan.type === 'GUILD_TEXT'
                        ).size
                    } Text Channels | ${
                        interaction.guild.channels.cache.filter(
                            (chan) => chan.type === 'GUILD_CATEGORY'
                        ).size
                    } Categories | ${Math.round(
                        (interaction.guild.channels.cache.filter(
                            (chan) => chan.type === 'GUILD_VOICE'
                        ).size /
                            interaction.guild.channels.cache.size) *
                            100
                    )}% Voice Channels | ${Math.round(
                        (interaction.guild.channels.cache.filter(
                            (chan) => chan.type === 'GUILD_TEXT'
                        ).size /
                            interaction.guild.channels.cache.size) *
                            100
                    )}% Text Channels | ${Math.round(
                        (interaction.guild.channels.cache.filter(
                            (chan) => chan.type === 'GUILD_CATEGORY'
                        ).size /
                            interaction.guild.channels.cache.size) *
                ...
                {
                    name: ':keyboard: AFK Channel Timeout',
                    value: `${interaction.guild.afkTimeout}` + ' seconds',
                },
                { name: ':id: Guild ID', value: `${interaction.guild.id}` },
                {
                    name: ':man_in_tuxedo: Server Owner',
                    value: `<@${interaction.guild.ownerId}>`,
                },
                {
                    name: ':man_in_tuxedo: Server Owner ID',
                    value: `${interaction.guild.ownerId}`,
                },
                {
                    name: ':closed_lock_with_key: Server Verification Level',
                    value: `${interaction.guild.verificationLevel}`,
                },
                {
                    name: ':joystick: Roles Count',
