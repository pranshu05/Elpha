...
module.exports = {
    ...
    async execute(interaction) {
        ...
        if (user.id === '754381104034742415') {
            return interaction.reply('You cannot roast my developer')
        }
        if (user === interaction.user)
            return interaction.reply('You cannot roast yourself')
        if (user === interaction.client.user)
            return interaction.reply('You cannot roast me')
        ...
        if (
            ...
            return interaction.reply({
                content: `I don't have permission to send message in this channel`,
                ephemeral: true,
            })
        } else {
