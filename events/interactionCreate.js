    ...
    async execute(interaction){
        ...
        if(!command) return
            ...
            if(interaction.isSelectMenu()){
                ...
                if(choice == '1'){
                    if (member.roles.cache.some(role => role.id == '959447841355468801')) {
                ...
                if(choice == '3'){
                    if (member.roles.cache.some(role => role.id == '959447842282414130')) {
                        interaction.reply({content: "The role was successfully removed from you" , ephemeral: true})
                ...
                if(choice == '4'){
                    if (member.roles.cache.some(role => role.id == '959447842844467210')) {
                        interaction.reply({content: "The role was successfully removed from you" , ephemeral: true})
                ...
                if(choice == '5'){
                    if (member.roles.cache.some(role => role.id == '959447834254532658')) {
                        interaction.reply({content: "The role was successfully removed from you" , ephemeral: true})
                ...
                if(choice == '6'){
                    if (member.roles.cache.some(role => role.id == '959447834669752362')) {
                        interaction.reply({content: "The role was successfully removed from you" , ephemeral: true})
                ...
                if(choice == '7'){
                    if (member.roles.cache.some(role => role.id == '959447835181461554')) {
                        interaction.reply({content: "The role was successfully removed from you" , ephemeral: true})
                ...
                if(choice == '8'){
                    if (member.roles.cache.some(role => role.id == '959447835663802368')) {
                        interaction.reply({content: "The role was successfully removed from you" , ephemeral: true})
                ...
                if(choice == '9'){
                    if (member.roles.cache.some(role => role.id == '959447846166343740')) {
                        interaction.reply({content: "The role was successfully removed from you" , ephemeral: true})
                ...
                if(choice == '10'){
                    if (member.roles.cache.some(role => role.id == '959447845700767755')) {
                        interaction.reply({content: "The role was successfully removed from you" , ephemeral: true})
                ...
                if(choice == '11'){
                    if (member.roles.cache.some(role => role.id == '959447846745153586')) {
                        interaction.reply({content: "The role was successfully removed from you" , ephemeral: true})
